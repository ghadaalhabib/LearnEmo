...
# here
from datasets_daisee import DAiSEEMultiTaskDataset
# END Here
...
def build_dataset(is_train, test_mode, args):
    ...
    # Here
        ...
        dataset = DAiSEEMultiTaskDataset(
            anno_path=anno_path,
            data_path='/',
            mode=mode,
            clip_len=args.num_frames,
        ...
        nb_classes = 4  # Each head has 4 ordinal levels
    # Ends Here
